...
public class admin {
	...
	public admin() {
	JFrame main_GUI = new JFrame("Зарплатный калькулятор. Повременная система оплаты труда.");	// создание графического окна
	...
	main_panel.setVisible(true);
    	...
    	JLabel promo = new JLabel("Новый коэффициент премии");
    	promo.setBounds(30, 50, 150, 80);
    	main_panel.add(promo);
    	
    	JLabel can = new JLabel("Новый коэффициент премии");
